...
export default function MoneySource({iconType, moneySourceName, moneySourceID, balance}) {
    ...
    return (
        <View className="flex-row justify-start w-full bg-blue-100 px-5 pt-2 pb-3 space-x-3 rounded-lg mb-2.5 border-gray-300 border-2">
            ...
            <View className="justify-center items-end flex-1">
              <TouchableOpacity onPress={() => {navigation.navigate('MoneySourceDetailScreen', {moneySourceID:{moneySourceID}})}}>
