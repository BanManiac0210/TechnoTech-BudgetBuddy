...
export default function AddSavingScreen({navigation}) {
  ...
  return (
    <SafeAreaView>
      <PopupConfirm 
          popupText={"Đã tạo khoản tiết kiệm"}
      ...
      <View className="w-screen h-screen bg-white items-center justify-center px-[20] pt-[50] pb-[100]">
        ...
        >
          <View className="w-full flex-row space-x-3 items-center">
            <Text className="flex-1 font-bold text-xl text-purple-900">Tạo khoản tiết kiệm mới</Text>  
          </View>
          ...
          <View className="w-full flex-row space-x-3 items-center">
            ...
            <View className="flex-1 justify-center border-2 rounded-xl px-2.5 py-2 border-purple-200">
              <TextInput
                ...
                placeholder='Nhập tên khoản tiết kiệm'
                value={defaultName}
